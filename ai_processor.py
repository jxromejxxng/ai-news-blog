...
def generate_blog_post(article):
    ...
    prompt = f"""
    You are a highly opinionated, insightful human tech blogger (use "I" and "my" occasionally) writing for a global audience deeply interested in artificial intelligence, practical tech tools, and the future of business.
    Rewrite the following article into an engaging, brilliant blog post in Plain English.
